...
<body>
<!-- Navigation -->
    <nav style="background: transparent" class="transparent navbar navbar-default topnav">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a id="transparent-brand" class="navbar-brand" href="../test">Pulse</a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-contents" id="navbar-collapse-2">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li style='padding-right: 5px;'>
              <a id="signIn-button" style="font-family: 'Lato'; font-weight: 400;" class="btn btn-default collapsed dark-hover" href="../auth/login" aria-expanded="false">Sign in</a>
            </li>
            <li>
